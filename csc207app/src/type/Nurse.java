...
public class Nurse implements Serializable {
	...
	/** Username and password of the nurse. */
...
//	private HashMap<String, Patient> patientMap;
	...
	/** The Patient object of the patient being treated. */
	private Patient patient;
	
	/** The PatientDatabase object where all the data is being stored. */
...
//	private Map<String, String> patientInfo;
	...
	/**
	 * Sets and records the symptoms for the patient (not needed for phase III)
