...
public class Patient implements Serializable {
	...
	/** Arrival time of the patient into the ER. */
	private Calendar arrivalTime;
	
	/** The VitalSign object storing the vital signs of this patient */
	private VitalSign vitalSigns;
	
	/** The list of symptoms of this patient. */
	private List<String> symptoms;
	
	/** String version of the basic information of this patient. */
	private String patientInfo;
	
	/** Age of this patient. */
	private String age;
	
	/** The urgency ranking of this patient. */
	...
	/** The heart rate of this patient. */
	private int heartRate;
	
	/** The blood pressure of this patient. */
	private int bloodPressure;
	
	/** The prescription object storing the prescription data. */
	private Prescription prescriptions;
	
	/** A string storing whether or not the patient has seen by a doctor. */
	private String seenByDoctor;
	
	/** A unit of blood pressure. */
	private char bloodPressureUnit;
	
	/** The format to store dates in. */
	...
	/**
	 * First constructor used if vital signs have not been recorded
	 * 
	 * @param The patient's name
	 * @param The patient's date of birth (mmddyyyy).
	 * @param The patient's health card number.
	 * @param The patient's arrival time at the hospital.
	 */
	public Patient(String name, String dob, String cardNumber,
	 ...
	 * @param The patient's health card number.
	 * @param The patient's arrival time at the hospital.
	 * @param Whether or not the patient has seen as doctor.
	 * @param The patient's Vital signs.
	 * @param The patient's prescriptions.
	 */
	public Patient(String name2, String dob2, String cardNumber2,
		...
		this.setAge(); //calculate the age
		this.setUrgency(); //set the urgency on construction
	 ...
	 * 
	 * @param The updated blood pressure to set
	 * @param The updated temperature to set
	 * @param The updated heart rate to set
	 */
	public void setVitalSign(Integer newBloodPressure, Double newTemperature,
		...
		// this.hasVitalSign = true;
		setAge(); //set the age again
		setUrgency(); //calculates the urgency again
		return;
	}

	/**
	 * Updates the symptoms of the patient
	 * @param The new symptom recording to set
	 */
	...
	/**
	 * Sets that the patient has been seen by a doctor.
	 * @param The time the patient saw a doctor.
	 */
	...
	/**
	 * Sets that the patient has not been seen by a doctor.
	 */
	 ...
	 * @param The scanned info from the file.
	 * @return A new patient object with the information from file.
	 */
	 ...
	 * @param The general information of the patient to set
	 */
	 ...
	 * @param The patient's name to set
	 */
	 ...
	 * @param The patients date of birth (mmddyyyy) to set
	 */
	 ...
	 * @param The patient's health card number to set
	 */
	 ...
	 * @param The patient's arrival time at the hospital to set.
	 */
	 ...
	 * @param The patient's blood pressure unit of measurement to set
	 */
	 ...
	 * @param The patient's doctor to assign
	 */
	 ...
	 * @param The patient's prescription to set
	 */
	...
	/**
	 * Shows whether a patient has seen a doctor.
	 * @return A boolean showing if the patient has seen a doctor or not.
	 */
	 ...
	 *         cardNumber Arrival Time: [Time Stamp] seen/notseen
